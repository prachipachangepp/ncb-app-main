...
class UpdateScreen extends StatefulWidget {
  UpdateScreen(
      {Key? key,
      required this.loadingScreenCallBack,
...
class _UpdateScreenState extends State<UpdateScreen> {
  ...
  Future<bool> makeApiRequest(int value, String category) async {
    bool error = true;
    switch (category) {
      case "Banner":
        break;
      ...
      case "Chapter":
        ...
        break;
      case "Contact":
        staticContentBox.clear();
        error = await createContent();
        break;
      case "Copyright":
        staticContentBox.clear();
        error = await createContent();
      ...
      case "Testament":
        testamentBox.clear();
        error = await syncTestamentsToOffline();
        break;
      case "User":
        break;
      case "Verse":
        verseBox.clear();
        error = await getVerses();
        break;
    }
    return error;
  }
  ...
  Future<void> _updateProgress() async {
    ...
    bool l = false;
    int j = 0;
    while (i < widget.list.length) {
      if (j < widget.list.length) {
        bool outcome = await makeApiRequest(i, widget.list[i]);
        if (outcome) {
          error = false;
          setState(() {
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Text(
                        error
                            ? "Something went wrong while Updating data please contact admin or restart the Application"
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Please turn on your internet connection for Updating resources",
                        style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: Colors.white,
                            fontSize: 16),
